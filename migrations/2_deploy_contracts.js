...
module.exports = async function (deployer, _network, accounts) {
  ...
  const seedTokenBalance = async (token, trader) => {
    ...
    await dex.deposit(amount, web3.utils.fromAscii(symbol), {
      from: trader,
    });
  };
  ...
  // console.log("balance", balances[0].toString());
  // console.log("balance", balances[1].toString());
  // console.log("balance", balances[2].toString());
  // console.log("balance", balances[3].toString());
  ...
  await dex.createLimitOrder(BAT, 1200, 10, SIDE.BUY, { from: trader1 });
